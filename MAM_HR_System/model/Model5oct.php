...
CLASS Model {
 ...
 $sq4 = mysql_query("insert into family_info values('$emp_no','','','','','','','','','','','', '', '', '$_SESSION[txt_login_name]','','')");
	...
	public function add_company_info($emp_no, $date_of_joining, $comp_change_eff_date, $designation, $grade, $basic, $hra, $special, $conveyance,$lta, $pf_applicable, $prof_tax_applicable, $esi_applicable, $bank_branch_name, $account_no, $gratuity_applicable, $tds_applicable, $pension_fund_applicable,$pf_no, $pf_date,$dearness_pay, $da, $gross_salary, $ctc, $emp_type,$emp_cat,$date_confirm,$date_sep,$type_sep,$remark_sep,$salary_on_joining,$mode_of_payment, $lic_acc_1, $lic_amt_1, $lic_acc_2, $lic_amt_2, $loan_acc_1, $loan_amt_1, $loan_acc_2, $loan_amt_2, $lic_id_1, $lic_id_2, $lic_gratuity_1, $lic_gratuity_2, $loan_id_1, $loan_id_2, $loan_gratuity_1, $loan_gratuity_2)
	{
	//echo "in insert";
	...
	$sql = mysql_query("delete from comp_details where employee_no='$emp_no'");
	 ...
	 $sq = "insert into comp_details values ('$emp_no','$date_of_joining', '$comp_change_eff_date', '$designation', '$grade', '$bank_branch_name', '$account_no', '$basic', '$hra' ,'$special','$conveyance','$lta','$pf_applicable','$prof_tax_applicable','$esi_applicable','$tds_applicable','$gratuity_applicable','$pension_fund_applicable','$pf_no','$pf_date','$dearness_pay','$da','$gross_salary','$ctc','$emp_type','$emp_cat','$date_confirm','$date_sep','$type_sep','$remark_sep','$salary_on_joining','$mode_of_payment', '$lic_acc_1','$lic_id_1', '$lic_gratuity_1', '$lic_amt_1', '$lic_acc_2', '$lic_id_2', '$lic_gratuity_2', '$lic_amt_2', '$loan_acc_1', '$loan_id_1','$loan_gratuity_1', '$loan_amt_1', '$loan_acc_2', '$loan_id_2', '$loan_gratuity_2', '$loan_amt_2', '$date','$_SESSION[txt_login_name]','','')";
...
public function changepassword($uname, $currentpass, $changepass, $confirmpass)
	...
	public function addinfo($a, $b, $c, $d, $address4, $e, $f, $g, $h, $i, $j, $k, $m, $n, $o, $p, $q, $r, $s, $t, $u,$v,$w,$x,$commissionorate,$pla_ac_no)
	{
	//echo "in insert";
	if($a!='')
	{
	...
	$sq_delete = mysql_query("delete from company_info");
	 ...
	 $sq = "insert into company_info values ('$a', '$b', '$c', '$d', '$address4', '$e', '$f', '$g', '$h', '$i', '$j', '$k', '$m', '$n','$o', '$p', '$q', '$r', '$s', '$t', '$u','$v','$w','$x','$commissionorate','$pla_ac_no')";
...
public function add_grade_wise_compensation($grade, $compe_code, $amounts)
	...
	public function add_attendance($empl_no,$month_nob, $per_day_for_month, $holidays, $paid_leaves, $unpaid_leaves, $adj_days,$other_Hrs,$leave_encash_days, $suspention_days)
	{
	...
	public function update_attendance($empl_no,$month_nob, $per_day_for_month, $holidays, $paid_leaves, $unpaid_leaves, $adj_days,$other_Hrs,$leave_encash_days, $suspention_days)
	{
