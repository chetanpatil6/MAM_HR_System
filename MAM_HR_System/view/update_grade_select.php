...
function btnenable()
		    ...
		    var a= document.getElementById("cmb_grade").value;
...
?>
		...
		<form name="frm_update_grade" id="frm_update_grade" action="update_grade_details.php" method="post" onsubmit="return btnenable()">
		<center><table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Update Grade Details</center></font></td></tr></table>

		<table width="800" border="1" class="listing" align="center">
			<tr><td width="300"><b>Select Grade: </b></td>
				<td><select name="cmb_grade" id="cmb_grade" style="widows:250px">
				    <option value="select" selected="selected">Select</option>
					<?php
					$sq = mysql_query("select distinct grade from grade_comp_master");
