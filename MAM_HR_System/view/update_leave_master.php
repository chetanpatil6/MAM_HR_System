...
function update_month_leave_attendance()
{
...
xmlhttp.open("GET","update_month_leave_attendance.php?id1="+emp_name+"&id2="+month+"&id3="+from+"&id4="+to,true);
xmlhttp.send();
}
...
<tr><td colspan="15"><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Update Attendance</center></font></td></tr>

<tr><td><label><b>Select Employee </b></label></td><td><select name="cmb_to_employee_name" id="cmb_to_employee_name" style="width:200px" onchange="update_month_leave_attendance();">
...
?>
<td><label><b>Select Month</b></label></td><td><input type="text" name="txt_month" id="txt_month" disabled="disabled" value="<?php echo $month_active_no; ?>" size="15" onchange="update_month_leave_attendance();"/><button id="f_btn_month">...</button></td>
<script type="text/javascript">//<![avi[
      Calendar.setup({
        inputField : "txt_month",
        trigger    : "f_btn_month",
        onSelect   : function() { this.hide(); update_month_leave_attendance(); },
        showTime   : 12,
        dateFormat : "%Y-%m"
      });
	  </script>
<?php
    //$month_active_no = "2014-09";
...
while($res_employee_no = mysql_fetch_assoc($sq_employee_no))
{
	...
	{		
		...
		//echo $res_employee_no['employee_no']." Total paid Leaves".$total_paid_leaves."<br>";
		...
		//echo "Total cancelled Leaves".$total_paid_leaves_cancelled."<br>";
		$total_paid_leaves = $total_paid_leaves - $total_paid_leaves_cancelled;
		
		//echo $total_paid_leaves."<br>";
...
<tr><td align="right" width="50%"><input type="button" name="btn_save" id="btn_save" value=" Save " onclick="update_leave_attendance();"  />&nbsp;&nbsp;</td><td>&nbsp;&nbsp;<a href="update_leave_master.php"><font color="#FF0033">Next Employee</font></a>
</td></tr>
</table>
</div>
