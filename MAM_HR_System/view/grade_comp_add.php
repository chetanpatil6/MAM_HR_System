		...
		function run(id)
{
    ...
    <script type="text/javascript">
		...
		if(txtBox1=='D0001' || txtBox1=='D0002' || txtBox1=='D0003' || txtBox1=='E0003' || txtBox1=='E0004' || txtBox1=='E0005' || txtBox1=='E0006' || txtBox1=='D0008' || txtBox1=='D0007')
		{
...
<td><select name="txt_compe_code" id="txt_compe_code" style="width:250px" onchange="displayvalifapplicable()">
...
{
if($r['comp_code']!='E0005' && $r['comp_code']!='E0006' && $r['comp_code']!='D0007' && $r['comp_code']!='D0008')
{
