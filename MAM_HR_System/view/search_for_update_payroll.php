...
<?php include('../model/Model.php');
	 ...
	 if(isset($id)){ 
	  ...
	  {
	  ?>
	  <tr><th></th><th  style="background-color:#FFC993;"><center>Employee No.</center></th><th style="background-color:#FFC993;"><center>First Name</center></th><th  style="background-color:#FFC993;"><center>Last Name</center></th></tr>
	  <?php
	  }
