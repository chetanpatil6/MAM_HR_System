...
<table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Change Password</center></font></td></tr></table>
<center><table class="listing" border="1" width="500" >
<tr><td><b> User Name</b></td>
     <td><input type="text" name="txt_uname" id="txt_uname" value="<?php echo $_SESSION['txt_login_name']; ?>" disabled="disabled" />
	 </td></tr>
	 
	 <tr><td><b>Current PassWord</b></td>
	 <td><input type="password" name="txt_current_password" id="txt_current_password" /></td></tr>
	 
	 	 <tr><td><b>Change PassWord</b></td>
	 <td><input type="password" name="txt_change_password" id="txt_change_password" /></td></tr>


	 <tr><td><b>Confirm PassWord</b></td>
	 <td><input type="password" name="txt_confirm_password" id="txt_confirm_password" onblur="checkpassword()" /></td></tr>
	
	 
<tr><td colspan="2"><center><input type="button" name="btn_change_password" id="btn_change_password" value="Change" onclick="changepassword();" /><input type="reset" name="btn_reset" value="Cancel" /><!--<a href="">New User</a> --></center></td></tr>
