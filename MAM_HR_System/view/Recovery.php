...
<tr><td><b>Employee No:</b></td><td colspan="4"><input type="text" name="txt_emp_no" id="txt_emp_no" /></td><td><b>Recovery Title:</b></td><td><input type="text" name="txt_recovery_title" id="txt_recovery_title" /></td>
</tr>
...
<tr><td><b>Compensation Code:</b></td><td colspan="6"><input type="text" name="txt_comp_code" id="txt_comp_code"  size="20" /></td></tr>	 
...
<tr><td><b>Remark:</b></td><td colspan="6"><input type="text" name="txt_remark" id="txt_remark" size="30" /></td></tr>

<tr><td colspan="8"><center><input type="button" name="btn_add_attendance" id="btn_add_attendance" value="Save" /><input type="reset" name="btn_reset" value="Cancel" /></center></td></tr>
