...
//function employee_leaves_search_one()
//{
//
...
//	if (xmlhttp.readyState==4 && xmlhttp.status==200)
//	{
//	var myTable = document.getElementById('tableDisplayOne');
//	var tBody = myTable.getElementsByTagName('tbody')[0];
//	tBody.innerHTML = xmlhttp.responseText;
//	}
//	}
//xmlhttp.open("GET","employee_leaves_search_one.php?option="+emp_no,true);
//xmlhttp.send();
//}
...
<tr><td colspan="15"><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Modify Deposit Leaves</center></font></td></tr>
...
<center><table width="950" border="1" id="tableDisplay">
<thead>
...
{	
             ...
             // $sq_leaves_type = mysql_fetch_assoc(mysql_query("select * from leaves_type"));
           //  $query = mysql_fetch_assoc(mysql_query("select leavedays_onhand from balanced_leaves where employee_no='".$res_employee_no['employee_no']."' and leave_short_code = '".$sq_leaves_type['leave_short_code']."';"));
//echo $query['leavedays_onhand'];

//$sq_leaves_type = mysql_fetch_assoc(mysql_query("select * from leaves_type"));
//$query = mysql_query("select leavedays_onhand from balanced_leaves where employee_no='".$res_employee_no['employee_no']."' and leave_short_code = '".$res_leaves_type['leave_short_code']."';");
			//$countOne = 0;
			//$total = 0;
			//while($res_leaves_type = mysql_fetch_assoc($query))
				
			//{
			  //  $query="select leavedays_onhand from balanced_leaves where employee_no = ".$res_employee_no['employee_no']." and leave_short_code = ".$res_leaves_type['leave_short_code'].";";
      			//$Leaves = mysql_fetch_assoc(mysql_query($query));
...
/*              $empBalance = "NEW- ".$res_employee_no['first_name']." ".$res_employee_no['middle_name']." ".$res_employee_no['last_name']." "." CL =".$query['leavedays_onhand']." "." FL =".$query['leavedays_onhand']." "." EL =".$query['leavedays_onhand']." "." ML =".$query['leavedays_onhand']." "." SP =".$query['leavedays_onhand']." "." PL =".$query['leavedays_onhand'];
$countOne++;
*///}
}	
...
<table width="950" border="1"  id="tableDisplay1">
<tbody>
</tbody>
</table>
...
<tr><td align="right" width="50%"><input type="button" name="btn_save" id="btn_save" value=" Save " onclick="remove_employee_leaves();" />&nbsp;&nbsp;</td><td>&nbsp;&nbsp;<a href="remove_employee_leaves.php"><font color="#FF0033">Next Modify Deposit Leave</font></a>
</td></tr>
</table>
</form>
