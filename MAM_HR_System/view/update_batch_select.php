...
function btnenable()
		    ...
		    var a= document.getElementById("cmb_batch_no").value;
...
?>
		...
		<form name="frm_update_batch" id="frm_update_batch" action="update_batch.php" method="post" onsubmit="return btnenable()">
		<center><table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Update Batch</center></font></td></tr></table>

		<table width="800" border="1" class="listing" align="center">
			<tr><td width="300"><b>Select Batch No. : </b></td>
				<td><select name="cmb_batch_no" id="cmb_batch_no" style="width:300px">
				    <option value="select" selected="selected">Select</option>
					<?php
					$sq = mysql_query("select * from batch_hdr");
					while($r = mysql_fetch_assoc($sq))
					{
					  echo "<option value='$r[batch_no]'>$r[batch_no] - $r[month_no] - $r[remark]</option>";
					}
