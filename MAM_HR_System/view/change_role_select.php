...
<li><a href="change_role_select.php" class=" active"><span class="l"></span><span class="r"></span><span class="t">Change Role</span></a>
</li>
                ...
                <div class="art-contentLayout">
                    <div class="art-content">
                        ...
                        <div class="art-Post-inner">
										...
										<form action="change_role.php" method="post" name="change_role"  onsubmit="return btnenable()">
...
<tr><td width="250"><label><b>Select Employee Id</b></label></td><td>
                                    <select name="txt_emp_id" id="txt_emp_id">
...
<br /><br />
<tr><td colspan="5"><center><input type="submit" name="btn_next" id="btn_next" value="Next" /><input type="reset" name="btn_reset" value="Cancel" /></center></td></tr>
