...
<table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Batch</center></font></td></tr></table>
<center><table class="listing" border="1" width="800" >
<tr><td><b>Batch No:</b></td><td colspan="4"><input type="text" name="txt_batch_no" id="txt_batch_no" /></td><td><b>Month No:</b></td><td><input type="text" name="txt_month_no" id="txt_month_no" /></td>
</tr>
<tr><td><b>Remark:</b></td><td colspan="6"><textarea name="txt_remark" id="txt_remark" cols="50" rows="3" ></textarea></td>
</tr>

	 
<tr><td colspan="8"><center><input type="button" name="btn_add_batch" id="btn_add_batch" value="Save" /><input type="reset" name="btn_reset" value="Cancel" /></center></td></tr>
