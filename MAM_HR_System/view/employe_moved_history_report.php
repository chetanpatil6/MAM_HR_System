...
<head>
    ...
    Base template (witdout user's data) checked by http://validator.w3.org : "This page is valid XHTML 1.0 Transitional"
    -->
...
<link rel="stylesheet" type="text/css" href="../js/jquery.autocomplete.css" />
    ...
    function emp_moved_filter()
	{
	//alert("Hello");
	var str1=document.getElementById('cmb_date').value;
	...
	//alert(str2);
		...
		{
		var myTable = document.getElementById('tbl_emp_moved_dashboard');
		var tBody = myTable.getElementsByTagName('tbody')[0];
		tBody.innerHTML = xmlhttp.responseText;
		
		}
		}
	xmlhttp.open("GET","emp_moved_filter.php?id1="+str1,true);
	xmlhttp.send();
	} 
	</script>
...
<ul>
<li><a href="comp_head_add.php"><span class="l"></span><span class="r"></span><span class="t"><font color="#000000">Add Compensations</font></span></a>
<ul>
                ...
                <div class="art-contentLayout">
                    <div class="art-content">
						...
						<h2 class="art-PostHeader">
                                           Employee Moved History
                                        </h2>
										<br />
										<form action="#" name="moved_history_reprt" method="post" >
										<center>
										<table border="1" width="400">
										<tr>
										<td width="150">Moved By Date</td><td>
										<select name="cmb_date" id="cmb_date" onchange="emp_moved_filter()">
										<option value="All">All</option>
										<?php
										  $sql_date=mysql_query("select distinct(moved_date) from emp_move_details");
										  while($row_date=mysql_fetch_assoc($sql_date))
										  {
										    echo "<option value=$row_date[moved_date]>$row_date[moved_date]</option>";
										  }
										?>
										</select>
										</td>
										...
										<br /><br />
										<table width="750" border="1" style="border-style:none">
										<th width="70" height="30">Employee No</th><th width="200">Employee Name</th><th width="200">Previous Company Name</th><th width="300">New Company Name</th><th>New Employee No</th><th width="70">Transfer Date</th>
										</table>
										<div class="table" align="center" >
											<table width="750" id="tbl_emp_moved_dashboard" border="1" style="border-style:none">
											<tbody >
											<?php
											$count=0;
											 $sql=mysql_query("select * from emp_move_details");
											...
											echo '<tr><td width="70">'.$row['employee_no'].'</td><td width="170">'.$row['first_name'].' '.$row['last_name'].'</td><td width="170">'.$_SESSION['company_name'].'</td><td width="170">'.$row['to_company_name'].'</td><td width="70">'.$row['to_employee_no'].'</td><td width="70">'.$row['moved_date'].'</td></tr>';
											 ...
											 echo '<tr><td colspan="6">Total no. of Employees:'.$count;
											?>
											</td></tr>											
											</tbody>
											</table>
