...
function btnenable()
		    ...
		    var a = document.getElementById("cmb_month_no1").value;
            if(a=='select')
			{
				alert("Select Month No");
				return false
			}
			}
</script>
...
function submitForm(action) {
    ...
    form = document.getElementById('payroll_print');

    form.action = action;
    form.submit();
}

function display_to_year(yrval)
{
  toyr = parseInt(yrval) + 1;
  document.getElementById("cmb_to_year").value = toyr;
  document.getElementById("cmb_to_year1").value = toyr;
}

function display_to_year_contribution(yrval)
{
  toyr = parseInt(yrval) + 1;
  document.getElementById("cmb_to_contribution_year").value = toyr;
  document.getElementById("cmb_to_contribution_year1").value = toyr;
}

function validate6aform()
{
    var a = document.getElementById("cmb_from_year").value;
	if(a == 'select')
	{
...
{
 	var a = document.getElementById("cmb_from_contribution_year").value;
	if(a == 'select')
	{
	  alert("Please Select the Year");
	  return false;
...
<!-- Form to process payroll info for all employees on "Process" button click, which will fill up the payroll_hdr and payroll_dtls tables -->										
										


<!--<form name="pf_print" id="pf_print" action="../excel/pf_report.php" method="post">
<table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Reports</center></font></td></tr></table> 

<center><table width="800" class="listing" border="1">
	
<tr><td colspan="2"><b><center>PF Report</center></b></td></tr>							
<tr><td><b>Select Month: </b><select name="cmb_month_no_pf_print" id="cmb_month_no_pf_print">
<?php  
...
?></select></td>
<td><input type="submit" name="btn_pf_print" id="btn_pf_print" value="PF Print" /></td>
</tr>
...
<form name="deduction_print" id="deduction_print" action="../excel/deduction_report.php" method="post">

<table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Reports</center></font></td></tr></table> 
<br />
<center><table width="800" class="listing" border="1">
	
<tr><td colspan="2"><b><center>Salary Deduction Report</center></b></td></tr>						
<tr><td width="300"><b>Select Month: </b><select name="cmb_month_no_deduction" id="cmb_month_no_deduction">
<?php  

$sq = mysql_query("select * from month_control");
while($r = mysql_fetch_assoc($sq))
{
  $month = date('M-Y', strtotime($r['month_no']));
  echo "<option value='$r[month_no]'>$month</option>";
}
?></select></td>
<td><input type="submit" name="btn_deduction_print" id="btn_deduction_print" value="Print Deduction Report" /></td>
</tr>
...
<br /><br /><br /><br />
<form name="deduction_print" id="deduction_print" action="../excel/earning_report.php" method="post">

<center><table width="800" class="listing" border="1">
	
	<tr><td colspan="2"><b><center>Salary Earning Report</center></b></td></tr>							
<tr><td width="300"><b>Select Month: </b><select name="cmb_month_no_earning" id="cmb_month_no_earning">
<?php  
...
?></select></td>
<td><input type="submit" name="btn_earning_print" id="btn_earning_print" value="Print Earning Report" /></td>
</tr>
...
<br /><br /><br /><br />
<form name="deduction_print" id="deduction_print" action="../excel/gratuity_report.php" method="post">

<center><table width="800" class="listing" border="1">
	
	<tr><td colspan="2"><b><center>Gratuity Report</center></b></td></tr>							
<tr><td width="300"><b>Select Month: </b><select name="cmb_gratuity_month" id="cmb_gratuity_month">
<?php  
...
?></select></td>
<td><input type="submit" name="btn_gratuity_print" id="btn_gratuity_print" value="Print Gratuity Report" /></td>
</tr>
...
<br /><br /><br /><br />
<form name="deduction_print" id="deduction_print" action="../excel/lic_deduction_list.php" method="post">

<center><table width="800" class="listing" border="1">
	
	<tr><td colspan="2"><b><center>L.I.C Deduction List Report</center></b></td></tr>							
<tr><td width="300"><b>Select Month: </b><select name="cmb_lic_deduction_list_month" id="cmb_lic_deduction_list_month">
<?php  
...
?></select></td>
<td><input type="submit" name="btn_lic_deduction_list_print" id="btn_lic_deduction_list_print" value="Print LIC Deduction List" /></td>
</tr>
...
<br /><br /><br /><br />
<form name="deduction_print" id="deduction_print" action="../excel/loan_installment_list.php" method="post">

<center><table width="800" class="listing" border="1">
	
	<tr><td colspan="2"><b><center>Loan Installment List Report</center></b></td></tr>							
<tr><td width="300"><b>Select Month: </b><select name="cmb_loan_installment_list_month" id="cmb_loan_installment_list_month">
<?php  
...
?></select></td>
<td><input type="submit" name="btn_loan_installment_list_print" id="btn_loan_installment_list_print" value="Print Loan Installment List" /></td>
</tr>
...
<br /><br /><br /><br />
<form name="deduction_print" id="deduction_print" action="../excel/pt_report.php" method="post">

<center><table width="800" class="listing" border="1">
	
	<tr><td colspan="2"><b><center>Profession Tax Report</center></b></td></tr>							
<tr><td width="300"><b>Select Month: </b><select name="cmb_profession_tax_month" id="cmb_profession_tax_month">
<?php  
...
?></select></td>
<td><input type="submit" name="btn_pt_print" id="btn_pt_print" value="Profession Tax Report" /></td>
</tr>
...
<br /><br /><br /><br />
<form name="deduction_print" id="deduction_print" action="../excel/pf_report.php" method="post">

<center><table width="800" class="listing" border="1">
	
	<tr><td colspan="2"><b><center>Provident Fund Report</center></b></td></tr>							
<tr><td width="300"><b>Select Month: </b><select name="cmb_pf_month" id="cmb_pf_month">
<?php  
...
?></select></td>
<td><input type="submit" name="btn_pf_print" id="btn_pf_print" value="Print PF Report" /></td>
</tr>
...
<br /><br /><br /><br />
<form name="deduction_print" id="deduction_print" action="../excel/6A_form.php" method="post" onsubmit="return validate6aform()">

<center><table width="800" class="listing" border="1">
	
	<tr><td colspan="3"><b><center>6A Form</center></b></td></tr>							
<tr><td width="300"><b>From : </b><select name="cmb_from_year" id="cmb_from_year" onchange="display_to_year(this.value)">
<option value="select">Select</option>
<?php  

$sq = mysql_query("select distinct SUBSTRING(month_no, 1 ,4) as year from month_control");
while($r = mysql_fetch_assoc($sq))
{
...
<b> - To : </b><!--<select name="cmb_to_year" id="cmb_to_year">
<?php  
...
<input type="text" name="cmb_to_year1" id="cmb_to_year1"  size="5" disabled="disabled" />
<input type="text" name="cmb_to_year" id="cmb_to_year"  size="5" style="display:none"  />
</td>

<td><input type="submit" name="btn_6A_form_print" id="btn_6A_form_print" value="Print 6A Form Report" /></td>
</tr>
...
<br /><br /><br /><br />
<form name="deduction_print" id="deduction_print" action="../excel/contribution_report.php" method="post" onsubmit="return validatecontribution()">

<center><table width="800" class="listing" border="1">
	
	<tr><td colspan="3"><b><center>Contribution</center></b></td></tr>							
<tr><td width="300"><b>From : </b><select name="cmb_from_contribution_year" id="cmb_from_contribution_year" onchange="display_to_year_contribution(this.value)">
<option value="select">Select</option>
<?php  
...
<input type="text" name="cmb_to_contribution_year1" id="cmb_to_contribution_year1"  size="5" disabled="disabled" />
<input type="text" name="cmb_to_contribution_year" id="cmb_to_contribution_year"  size="5" style="display:none"  />
</td>

<td><input type="submit" name="btn_contribution_print" id="btn_contribution_print" value="Print Contribution Report" /></td>
</tr>
...
<br /><br /><br /><br />
<form name="deduction_print" id="deduction_print" action="../excel/ecr_report.php" method="post">

<center><table width="800" class="listing" border="1">
	
	<tr><td colspan="2"><b><center>Electronic Challan Cum Returns Report</center></b></td></tr>							
<tr><td width="300"><b>Select Month: </b><select name="cmb_ecr_month" id="cmb_ecr_month">
<?php  
...
?></select></td>
<td><input type="submit" name="btn_ecr_print" id="btn_ecr_print" value="Print ECR Report" /></td>
</tr>
...
<table width="900" class="listing">
	
	<tr>
	<td><center><b>Collective Reports</b></center></td></tr></table>


<br />
<form name="deduction_print" id="deduction_print" action="../excel/pf_collective_report.php" method="post">

<center><table width="800" class="listing" border="1">
	
	<tr>
	<td colspan="2"><b><center>PF Collective Report</center></b></td></tr>							
<tr><td><b>Select Company: </b><select name="cmb_company" id="cmb_company">
<option value="maharashtra_arogya_mandal">Maharashtra Arogya Mandal</option>
<option value="sane_guruji_arogya_kendra_hadapsar">Sane Guruji Arogya Kendra Hadapsar</option>
</select></td>
</tr>							
<tr><td><b>Select Month: </b><select name="cmb_pf_collective_month" id="cmb_pf_collective_month">
<?php  
...
?></select></td></tr>
<tr>
<td><center><input type="submit" name="btn_pf_collective_print" id="btn_pf_collective_print" value="PF Collective Report" /></center>
</td>
</tr>
...
<br /><br /><br /><br />
<form name="deduction_print" id="deduction_print" action="../excel/pt_report_collective.php" method="post">

<center><table width="800" class="listing" border="1">
	<tr>
	<td colspan="2"><b><center>PT Collective Report</center></b></td></tr>	
					
<tr><td><b>Select Month: </b><select name="cmb_pt_collective_month" id="cmb_pt_collective_month">
<?php  
...
?></select></td></tr>
<tr>
<td><center><input type="submit" name="btn_pt_collective_print" id="btn_pt_collective_print" value="PT Collective Report" /></center>
</td>
</tr>
