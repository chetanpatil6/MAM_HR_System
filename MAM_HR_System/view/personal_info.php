...
if($_SESSION['txt_login_name'] == 'aaditya' && $_SESSION['password_1'] == 'aytidaa')
{
...
row.cells[1].childNodes[0].value = foo1.counter;
    ...
    <script type="text/javascript">
		...
		function validate_emp_code()
		{
		   var div_val = document.getElementById("error1").innerHTML;
		   
		   if(div_val == 'Can not duplicate Employee Code, please enter another Employee Code')
		   {
		     var btn_personal_info = document.getElementById("btn_add_personal_info");
			 btn_personal_info.disabled=false;
		   }
...
<?php
$count1 = 0;
$sql=mysql_query("SELECT max(employee_no) as maxemp from empl_master order by employee_no");
...
<table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Personal Information</center></font></td></tr></table>
 <table border="1" width="900">
                     <tr><td><label><b>Employee Id*</b></label></td><td colspan="2" style="display:none"><input type="text" name="txt_emp_no1" id="txt_emp_no1" value="<?php echo $code1; ?>"><td colspan="2"><input type="text" name="txt_emp_no" id="txt_emp_no" value="<?php echo $code1; ?>" disabled="disabled"/></td></tr>
			<tr><td><label><b>Employee Code*</b></label></td><td colspan="2"><input type="text" name="txt_emp_code" id="txt_emp_code" /></tr>
			 <tr><td><label><b>Punching Code</b></label></td><td colspan="2"><input type="text" name="txt_punching_code" id="txt_punching_code" /></tr>
...
<td><label><b>Date of Birth</b></label></td><td><input type="text" name="txt_date_of_birth" id="txt_date_of_birth" disabled="disabled"  /><button id="f_btn" >...</button></td></tr>
...
<script type="text/javascript">//<![CDATA[
 ...
 <tr><td><label><b>Employee Code.</b></label></td><td><input type="text" name="txt_emp_no2" id="txt_emp_no2" disabled="disabled" value="<?php echo $code1; ?>" /><td style="display:none"><input type="text" name="txt_emp_no2" id="txt_emp_no2" value="<?php echo $code1; ?>" disabled="disabled" /></td><td><b>Employee Name</b></td>

<td><input type="text" name="txt_emp_name1" id="txt_emp_name1" disabled="disabled" /></td></tr>
<tr><td><label><b>Date of Joining*</b></label></td><td><input type="text" name="txt_date_of_joining" disabled="disabled" id="txt_date_of_joining" /><button id="f_btn1">...</button></td>
<td><label><b>Company Change Effective Date</b></label></td><td><input type="text" name="txt_comp_change_eff_date" disabled="disabled" id="txt_comp_change_eff_date" /><button id="f_btn_effective_date">...</button></td></tr>
<tr><td><label><b>Designation</b></label></td><td><input type="text" name="txt_designation" id="txt_designation" /></td>
<td><label><b>Grade</b></label></td><td><!--<input type="text" name="txt_grade" id="txt_grade" /> -->
...
<td colspan="4"><input type="text" name="txt_dept" id="txt_dept" /></td></tr>

<tr><td colspan="5" height="30"><label><b><center>Salary Structure</center></b></label></td>
</tr>

<tr><td height="30" colspan="2" style="display:none;"><label><b><center>Earnings</center></b></label></td><td colspan="6" height="30"><label><b><center>Deduction</center></b></label></td>
</tr>
...
<option value="notgrantable" selected="selected">NonGrantable</option>
</select>
</td></tr>

<tr><td style="display:none;"><label><b>Basic</b></label></td><td style="display:none;"><input type="text" name="txt_basic" id="txt_basic" onfocus="caltotal();" /></td>
<td><label><b>PF Applicable</b></label></td><td colspan="4"><input type="radio" name="chk_pf_applicable" id="chk_pf_applicable" value="Yes" /><b>YES</b>&nbsp;<input type="radio" name="chk_pf_applicable" id="chk_pf_applicable" value="NO" /><b>NO</b></td></tr>

<tr><td style="display:none;"><label><b>Dearness Pay</b></label></td><td style="display:none;"><input type="text" name="txt_dearness_pay" id="txt_dearness_pay" /></td>
<td><label><b>PF Number</b></label></td><td colspan="4"><input type="text" name="txt_pf_no" id="txt_pf_no" size="10" /><label><b>Date</b></label><input type="text" name="txt_pf_date" id="txt_pf_date" disabled="disabled" size="10" /><button id="btn_pf_date">...</button></td></tr>

<tr>
<td><label><b>PF UA Number</b></label></td><td colspan="4"><input type="text" name="txt_pf_uan_no" id="txt_pf_uan_no" size="10" /><label><b>PF UAN Date</b></label><input type="text" name="txt_pf_uan_date" id="txt_pf_uan_date" disabled="disabled" size="10" /><button id="btn_pf_uan_date">...</button></td>
</tr>

<tr><td style="display:none;"><label><b>DA</b></label></td><td style="display:none;"><input type="text" name="txt_da" id="txt_da" /></td>
<td><label><b>Prof Tax Applicable</b></label></td><td colspan="4"><input type="radio" name="chk_prof_tax_applicable" id="chk_prof_tax_applicable" value="Yes"  /><b>YES</b>&nbsp;<input type="radio" name="chk_prof_tax_applicable" id="chk_prof_tax_applicable" value="NO" /><b>NO</b></td>
</tr>


<tr><td style="display:none;"><label><b>HRA</b></label></td><td style="display:none;"><input type="text" name="txt_hra" id="txt_hra" /></td>
<td><label><b>Gratuity Applicable</b></label></td><td colspan="4"><input type="radio" name="chk_gratuity_applicable" id="chk_gratuity_applicable" value="Yes"  /><b>YES</b>&nbsp;<input type="radio" name="chk_gratuity_applicable" id="chk_gratuity_applicable" value="NO" /><b>NO</b></td>
</tr>


<tr><td style="display:none;"><label><b>LTA</b></label></td><td style="display:none;"><input type="text" name="txt_lta" id="txt_lta" /></td>
<td><label><b>TDS</b></label></td><td colspan="4"><input type="radio" name="chk_tds_applicable" id="chk_tds_applicable" value="Yes"  /><b>YES</b>&nbsp;<input type="radio" name="chk_tds_applicable" id="chk_tds_applicable" value="NO" /><b>NO</b></td>
</tr>

<tr><td style="display:none;"><label><b>Conveyance</b></label></td><td style="display:none;"><input type="text" name="txt_conveyance" id="txt_conveyance" /></td>
<td><label><b>ESI Applicable.</b></label></td><td colspan="4"><input type="radio" name="chk_esi_applicable" id="chk_esi_applicable" value="Yes"  /><b>YES</b>&nbsp;<input type="radio" name="chk_esi_applicable" id="chk_esi_applicable" value="NO" /><b>NO</b></td></tr>	



<tr><td style="display:none;"><label><b>Washing Allowance</b></label></td><td style="display:none;"><input type="text" name="txt_special" id="txt_special" /></td>
<td><label><b>Pension Fund Applicable</b></label></td><td colspan="4"><input type="radio" name="chk_pension_fund_applicable" id="chk_pension_fund_applicable" value="Yes"  /><b>YES</b>&nbsp;<input type="radio" name="chk_pension_fund_applicable" id="chk_pension_fund_applicable" value="NO" /><b>NO</b></td></tr>
</tr>


<tr><td style="display:none;"><label><b>Gross Salary</b></label></td><td colspan="3" style="display:none;"><input type="text" name="txt_gross_salary" id="txt_gross_salary" /><input type="button" name="Calculate" id="Calculate" onclick="caltotal();" value="Calculate" /></td></tr>
<tr>						 

<tr><td style="display:none;"><label><b>CTC</b></label></td><td colspan="3" style="display:none;"><input type="text" name="txt_ctc" id="txt_ctc" /></td></tr>
<tr>						 
...
<td><label><b>Employee Category</b></label></td><td><select name="txt_emp_cat" id="txt_emp_cat"><option></option><option>Medical  </option><option>Paramedical</option><option>Admin </option><option>Class4</option></select></td></tr>
<tr>						 


<tr><td><label><b>Date of Confirmation</b></label></td><td><input type="text" name="txt_date_confirm" disabled="disabled" id="txt_date_confirm"><button id="btn_confirm_date">...</button></td>
<td><label><b>Date of Separation</b></label></td><td><input type="text" name="txt_date_sep" disabled="disabled" id="txt_date_sep"><button id="btn_sep_date">...</button></td></tr>
<tr>
...
<tr><td><label><b>LIC Account No. 1</b></label></td><td><input type="text" name="txt_lic_acc_no_1" id="txt_lic_acc_no_1"  /></td>

<td><label><b>Amount</b></label></td><td><input type="text" name="txt_lic_amt_1" id="txt_lic_amt_1" /></td></tr>

<tr><td><label><b>LIC Account No. 2</b></label></td><td><input type="text" name="txt_lic_acc_no_2" id="txt_lic_acc_no_2"  /></td>
<td style="display:none"><label><b>LIC ID Number</b></label></td><td style="display:none"><input type="text" name="txt_lic_id_number_2" id="txt_lic_id_number_2"  /></td>
<td style="display:none"><label><b>LIC Gratuity Number</b></label></td><td style="display:none"><input type="text" name="txt_lic_gratuity_number_2" id="txt_lic_gratuity_number_2"  /></td>
<td><label><b>Amount</b></label></td><td><input type="text" name="txt_lic_amt_2" id="txt_lic_amt_2" /></td></tr>

<tr><td><label><b>LIC ID Number</b></label></td><td><input type="text" name="txt_lic_id_number_1" id="txt_lic_id_number_1"  /></td>
<td><label><b>LIC Gratuity Number</b></label></td><td><input type="text" name="txt_lic_gratuity_number_1" id="txt_lic_gratuity_number_1"  /></td></tr>
</table>

<table border="1" width="900">
<tr><td colspan="8" height="30"><label><b><center>Loan Details</center></b></label></td></tr>

<tr><td colspan="2"><label><b>Loan Account No. 1</b></label></td><td><input type="text" name="txt_loan_acc_no_1" id="txt_loan_acc_no_1"  /></td>
<td style="display:none"><label><b>Loan ID Number</b></label></td><td style="display:none"><input type="text" name="txt_loan_id_number_1" id="txt_loan_id_number_1"  /></td>
<td style="display:none"><label><b>Loan Gratuity Number</b></label></td><td style="display:none"><input type="text" name="txt_loan_gratuity_number_1" id="txt_loan_gratuity_number_1"  /></td>
<td colspan="2"><label><b>Amount</b></label></td><td colspan="3"><input type="text" name="txt_loan_amt_1" id="txt_loan_amt_1" /></td></tr>

<tr><td colspan="2"><label><b>Loan Account No. 2</b></label></td><td><input type="text" name="txt_loan_acc_no_2" id="txt_loan_acc_no_2"  /></td>
<td style="display:none"><label><b>Loan ID Number</b></label></td><td style="display:none"><input type="text" name="txt_loan_id_number_2" id="txt_loan_id_number_2"  /></td>
<td style="display:none"><label><b>Loan Gratuity Number</b></label></td><td style="display:none"><input type="text" name="txt_loan_gratuity_number_2" id="txt_loan_gratuity_number_2"  /></td>
<td colspan="2"><label><b>Amount</b></label></td><td colspan="3"><input type="text" name="txt_loan_amt_2" id="txt_loan_amt_2" /></td></tr>
</table>
...
<tr><td><label><b>Employee Code.</b></label></td><td><input type="text" name="txt_emp_no3" id="txt_emp_no3" disabled="disabled" value="<?php echo $code1; ?>" /><td style="display:none;"><input type="text" name="txt_emp_no3" id="txt_emp_no3" value="<?php echo $code1; ?>" disabled="disabled"  /></td><td><b>Employee Name</b></td>
...
<form action="#" name="experience_info" method="post">
	    <table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Experience Information</center></font></td></tr></table>       
                               ...
                               <tr><td><label><b>Employee Code.</b></label></td><td><input type="text" name="txt_emp_no4" id="txt_emp_no4" disabled="disabled" value="<?php echo $code1; ?>" /><td style="display:none;"><input type="text" name="txt_emp_no4" id="txt_emp_no4" value="<?php echo $code1; ?>" disabled="disabled" /></td><td><b>Employee Name</b></td>
...
<tr><td colspan="5"><center><input type="button" name="btn_add_experience_info" id="btn_add_experience_info" value="Save" onclick="add_experience();" <?php if($_SESSION['role']=='ViewOnly')
 ...
 /><input type="reset" name="btn_reset" id="btn_reset" value="Cancel" /></center></td></tr> 
  ...
  <form action="#" name="family_info" method="post">          
                               ...
                               <tr><td><label><b>Employee Code.</b></label></td><td colspan="3"><input type="text" name="txt_emp_no5" id="txt_emp_no5" disabled="disabled" value="<?php echo $code1; ?>" /><td colspan="3" style="display:none;"><input type="text" name="txt_emp_no5" id="txt_emp_no5" value="<?php echo $code1; ?>" disabled="disabled" /></td></tr>
...
<center><table>
<tr><td></td></tr>
<tr><td><font size="+2">Welcome to Leave Management</font></td></tr>
<tr><td></td></tr>  
<tr><td></td></tr>
<tr><td></td></tr>
<tr><td><a href="add_employee_leaves.php"><span class="l"></span><span class="r"></span><span class="t"><font size="+1">Leave Managment</font></span></a></td></tr>
<tr><td></td></tr>
<tr><td><a href="add_employee_leaves.php"><span class="l"></span><span class="r"></span><span class="t"><font size="+1">Deposit Leaves</font></span></a></td></tr>
<tr><td></td></tr>
<tr><td><a href="remove_employee_leaves.php"><span class="l"></span><span class="r"></span><span class="t"><font size="+1">Modify Deposit Leaves</font></span></a></td></tr>
<tr><td></td></tr>
<tr><td><a href="add_leave_managment_form.php"><span class="l"></span><span class="r"></span><span class="t"><font size="+1">Leave Application</font></span></a></td></tr>
<tr><td></td></tr>
<tr><td><a href="cancel_leaves_select.php"><span class="l"></span><span class="r"></span><span class="t"><font size="+1">Leave Cancellation</font></span></a></td></tr>
<tr><td></td></tr>
<tr><td><a href="add_leave_master.php"><span class="l"></span><span class="r"></span><span class="t"><font size="+1">Add Attendance</font></span></a></td></tr>
<tr><td></td></tr>
<tr><td><a href="add_leave_transfer_type.php"><span class="l"></span><span class="r"></span><span class="t"><font size="+1">Trnasfer Leaves</font></span></a></td></tr>
<tr><td></td></tr>
<tr><td><a href="add_leave_encashment_form.php"><span class="l"></span><span class="r"></span><span class="t"><font size="+1">Leave Encashment</font></span></a></td></tr>
</table></center>
</form>
