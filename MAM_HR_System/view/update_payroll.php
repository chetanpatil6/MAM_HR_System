...
<tr><td><b>Compensation Code:</b></td><td><input type="text" name="txt_comp_code" id="txt_comp_code"  size="20" value="<?php echo $row['comp_code']; ?>" /></td>
<td><b>Code Name:</b></td><td><input type="text" name="txt_code_name" id="txt_code_name" value="<?php echo $row['code_name']; ?>" /></td></tr>
...
<tr><td><b>When to pay this code </b></td><td><b>P - Payroll</b><input type="radio" name="rdb_when_to_pay" id="rdb_when_to_pay" value="P" <?php 
if($row['pay_when']=='P')
{
?> checked="checked" <?php } ?>  /></td><td><b>A - Once in year</b><input type="radio" name="rdb_when_to_pay" id="rdb_when_to_pay" value="A" <?php 
if($row['pay_when']=='A')
{
?> checked="checked" <?php } ?>  /></td><td><b>X - as and when needed</b><input type="radio" name="rdb_when_to_pay" id="rdb_when_to_pay" value="X" <?php 
if($row['pay_when']=='X')
{
...
<!--<script type="text/javascript" src="../js/jquery-1.4.js"></script> -->
							 ...
							 <?php
$emp_no = $_POST['rdb_emp_no'];
$sql = mysql_query("select * from emp_comp_master where comp_code='$emp_no'");
while($row = mysql_fetch_assoc($sql))
{
?>				
...
<center><table class="listing" border="1" width="800" >
<tr><td><b>Employee Code:</b></td><td><input type="text" name="txt_emp_code" id="txt_emp_code" value="<?php echo $row['employee_no'] ?>" /></td><td><b>Compensation Code:</b></td><td><input type="text" name="txt_com_code" id="txt_com_code"  size="20" value="<?php echo $row['comp_code'] ?>" /></td>
</tr>
<tr><td><b>Comp. Change Effective Date</b></td><td colspan="3"><input type="text" name="txt_comp_change_eff_date" id="txt_comp_change_eff_date" value="<?php echo $row['comp_change_eff_date'] ?>" /><button id="f_btn" >...</button></td></tr>

<tr><td><b>Amount</b></td><td colspan="3"><input type="text" name="txt_amount" id="txt_amount" value="<?php echo $row['amount'] ?>"  /></td></tr>
...
<!--<script type="text/javascript" src="../js/ajax.js"></script>
 --><!--<script type="text/javascript" src="../js/jquery-1.4.js"></script> -->
	   ...
	   <?php
$emp_no = $_POST['rdb_emp_no'];
$sql = mysql_query("select * from grade_comp_master where comp_code='$emp_no'");
while($row = mysql_fetch_assoc($sql))
{
?>				
...
<center><table class="listing" border="1" width="800" >
<tr><td><b>Grade:</b></td><td><input type="text" name="txt_grade" id="txt_grade" value="<?php echo $row['grade'] ?>" /></td><td><b>Compensation Code:</b></td><td><input type="text" name="txt_compe_code" id="txt_compe_code"  size="20" value="<?php echo $row['comp_code'] ?>" /></td>
</tr>

<tr><td><b>Amount</b></td><td colspan="3"><input type="text" name="txt_amounts" id="txt_amounts"  value="<?php echo $row['amount'] ?>" /></td></tr>
			 
<tr><td colspan="5"><center><input type="button" name="btn_update_grade_wise_compensation" id="btn_update_grade_wise_compensation" value="Update" onclick="update_grade_wise_compensation();"  /><input type="reset" name="btn_reset" value="Cancel" /></center></td></tr>
...
<tr><td colspan="8"><center><input type="button" name="btn_update_attendance" id="btn_update_attendance" value="Update" onclick="update_attendance();" /><input type="reset" name="btn_reset" value="Cancel" /></center></td></tr>
