...
<input type="text" name="txt_counter" id="txt_counter" />
<?php
$_SESSION['counter'] = 1;
?>
<table width="900" id="dataTable" border="1">

<td width="60"><input type="text" name="txt_year_of_passing" id="txt_year_of_passing" size="13" /><button id="<?php echo $_SESSION['counter'];  ?>"><?php 
