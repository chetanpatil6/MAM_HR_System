...
<table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Update Month Control Details</center></font></td></tr></table>
<center><table class="listing" border="1" width="800">
<?php
$month_no = $_POST['cmb_month_no'];
$sq = mysql_query("select * from month_control where month_no='$month_no'");
while($r = mysql_fetch_assoc($sq))
{
?>
<tr><td><b>Month No:</b><font color="#FF0000">*</font></td><td colspan="4"><input type="text" name="txt_month_no" id="txt_month_no" value="<?php echo $r['month_no']; ?>" disabled="disabled" /></td>
</tr>
<tr><td><b>Month Active:</b><font color="#FF0000">*</font></td><td><b>Active</b><input type="radio" name="rdb_month_avtive" id="rdb_month_avtive" value="Y" <?php if($r['month_active'] == 'Y') { ?> checked="checked" <?php } ?> /></td><td><b>Closed</b><input type="radio" name="rdb_month_avtive" id="rdb_month_avtive" value="N" <?php if($r['month_active'] == 'N') { ?> checked="checked" <?php } ?> /></td>
</tr>

<?php
if($r['process_status'] == 'Complete') 
{

?>
<tr><td><b>No of Calendar Days in Month</b><font color="#FF0000">*</font></td><td colspan="3"><input type="text" name="txt_no_days" id="txt_no_days" value="<?php echo $r['no_days']; ?>" disabled="disabled"/></td></tr>
	 
<tr><td><b>Per Day Divisor</b><font color="#FF0000">*</font></td><td colspan="3"><input type="text" name="txt_per_day_divisor" id="txt_per_day_divisor" value="<?php echo $r['per_day_divisor']; ?>" disabled="disabled"/></td></tr>

<tr><td><b>Dearness Allowance Index</b></td><td colspan="3"><input type="text" name="txt_da_index" id="txt_da_index" value="<?php echo $r['da_index']; ?>" disabled="disabled"/><b>%</b></td></tr>

<tr><td><b>H.R.A. Index</b></td><td colspan="3"><input type="text" name="txt_hra_index" id="txt_hra_index" value="<?php echo $r['hra_index']; ?>" disabled="disabled"/><b>%</b></td></tr>

<tr><td><b>Bonus Index</b></td><td colspan="3"><input type="text" name="txt_bonus_index" id="txt_bonus_index" value="<?php echo $r['bonus_index']; ?>" disabled="disabled"/><b>%</b></td></tr>

<tr><td colspan="5"><center><input type="button" name="btn_update_month_control" id="btn_update_month_control" value="Update" onclick="update_month_control();" /><input type="reset" name="btn_reset" value="Cancel" /></center></td></tr>
...
{
?>
<tr><td><b>No of Calendar Days in Month</b><font color="#FF0000">*</font></td><td colspan="3"><input type="text" name="txt_no_days" id="txt_no_days" value="<?php echo $r['no_days']; ?>" /></td></tr>
	 
<tr><td><b>Per Day Divisor</b><font color="#FF0000">*</font></td><td colspan="3"><input type="text" name="txt_per_day_divisor" id="txt_per_day_divisor" value="<?php echo $r['per_day_divisor']; ?>" /></td></tr>

<tr><td><b>Dearness Allowance Index</b></td><td colspan="3"><input type="text" name="txt_da_index" id="txt_da_index" value="<?php echo $r['da_index']; ?>" /><b>%</b></td></tr>

<tr><td><b>H.R.A. Index</b></td><td colspan="3"><input type="text" name="txt_hra_index" id="txt_hra_index" value="<?php echo $r['hra_index']; ?>" /><b>%</b></td></tr>

<tr><td><b>Bonus Index</b></td><td colspan="3"><input type="text" name="txt_bonus_index" id="txt_bonus_index" value="<?php echo $r['bonus_index']; ?>" /><b>%</b></td></tr>
