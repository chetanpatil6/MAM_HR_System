...
<form name="payroll_print" id="payroll_print" action="../report/encashment.php" method="post" target="_blank" onsubmit="return btnenable()">
<table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Leaves Encashment</center></font></td></tr></table> 

<center><table width="762" class="listing" border="1">
	
							
<tr><td><b>Select Year: </b><select name="cmb_month_no1" id="cmb_month_no1">

<option value="select">Select</option>
<?php  

$sq = mysql_query("SELECT distinct SUBSTRING_INDEX(`month_no` ,'-',1 ) AS  `year` 
FROM  `month_control`");
//$sq = mysql_query("select distinct month_no from month_control");
//$sq = mysql_query("SELECT DISTINCT DATE_FORMAT(month_no, '%Y') FROM month_control");
//$sq = mysql_query("SELECT EXTRACT(YEAR FROM month_no) AS month_no FROM month_control");
...
//list($year,$month) = preg_split('[-]', $month_active_no);
 ...
 // echo "<option value='$year'>$r['year']</option>";
}
?></select></td>
</tr>
...
<td><center><input type="submit" value="Print Leaves Encashment" name="btn_print" id="btn_print" onclick="submitForm('../report/encashment.php')" /></center></td></tr>
...
<center><table width="762" border="1">
