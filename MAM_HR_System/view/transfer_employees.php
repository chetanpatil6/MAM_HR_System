...
<script type="text/javascript">
		...
		$(document).ready(function(){
                $('#cmb_company_name').change(function(){
                  //  console.log($(this));

                    $.get("company_employees.php", {option:$(this).val()},  function(data){
                        $('#cmb_to_employee_name').html(data);
                    });
                });
            });
	</script>
...
<table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Move Employee</center></font></td></tr></table>
<center><table align="center" border="1" width="800">
<?php
$arr = array();
$arr_dbname = array();
...
?>
<tr><td><label><b>From Company Name*</b></label></td><td>
...
for($i=0;$i<$len;$i++)
{
  ...
  if($arr[$i] == $_SESSION['company_name'])
  echo "<option value='$arr_dbname[$i]'>$arr[$i]</option>";
}
...
<td><b>Employee Name*</b></td><td><select name="cmb_to_employee_name" id="cmb_to_employee_name" style="width:200px">
<option value="select">Select</option>
</select>
</td>
</tr>
...
<tr><td><label><b>To Company Name*</b></label></td><td colspan="3">
<?php
$arr = array();
$arr_dbname = array();
?>
<select name="cmb_to_company_name" id="cmb_to_company_name" style="width:300px"> 
<option value="select">Select</option>   
<?php
foreach($xml->children() as $child)
{   
...
<tr><td colspan="4"><center><input type="button" name="btn_move_employee" id="btn_move_employee" value="Move Employee" onclick="move_employee()" />
<a href="transfer_employees.php">
<input type="button" name="btn_move" value="Move New" /></a>
