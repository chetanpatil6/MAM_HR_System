...
function btnenable()
		    ...
		    var a= document.getElementById("cmb_comp_code").value;
            
			
			if(a=='select')
			{
		alert("Select Compensation Code");
			return false
			}
			}
</script>
...
?>
		...
		<form name="frm_update_comp" id="frm_update_comp" action="update_compensation_details.php" method="post" onsubmit="return btnenable()">
		<center><table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Update Compensation Details</center></font></td></tr></table>

		<table width="800" border="1" class="listing" align="center">
			<tr><td width="300"><b>Select Compensation Code: </b></td>
				<td><select name="cmb_comp_code" id="cmb_comp_code" style="width:300px">
				    <option value="select" selected="selected">Select</option>
					<?php
					$sq = mysql_query("select * from comp_head order by comp_code");
