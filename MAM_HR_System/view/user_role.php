...
<tr><td width="65"><b><center>Sr No.</center></b></td><td width="335"><b><center>Employee ID</center></b></td><td><b><center>Role</center></b></td></tr>
</table>
...
<td width="335"><input type="text" name="txt_emp_id" id="txt_emp_id"  >
</td><td><select name="txt_role" id="txt_role" style="width:300px" ><option selected="selected"></option><option>Admin</option><option>SuperUser</option><option>ViewOnly</option></select></td>
</tr>
</table>          
...
<tr><td colspan="5"><center><input type="button" name="btn_add_user_role" id="btn_add_user_role" value="Save" onclick="add_user_role();"  /><input type="reset" name="btn_reset" id="btn_reset" value="Cancel" /></center></td></tr> 
