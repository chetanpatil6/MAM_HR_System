...
<tr><td colspan="5"><center><input type="button" name="btn_add_user" id="btn_add_user" value="Save" onclick="add_new_dearness_allowance();"  /><input type="reset" name="btn_reset" id="btn_reset" value="Cancel" /></center></td></tr> 
