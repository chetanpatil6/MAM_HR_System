...
<?php 
$sq = mysql_query("select * from user where user_name='$_POST[txt_emp_id]'");
...
?>
										...
										<form name="change_role" method="post" action="#">
										 <table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Change Role</center></font></td></tr></table>
										<center><table width="500" border="1">
										<tr><td width="400"><b><center>Employee Id</center></b></td><td><center><b>Role</b></center></td></tr>
								
<tr><td><b><center><input type="text" name="txt_emp_id" id="txt_emp_id" size="20" value="<?php echo $row['user_name'] ?>" disabled="disabled" /></center></td>
<td><select name="txt_role" id="txt_role" style="width:270px" ><option selected="selected"><?php echo $row['role']; ?></option><op<option>Admin</option><option>SuperUser</option><option>ViewOnly</option></select></td></tr>
		
<tr><td colspan="2"><center><input type="button" name="btn_change_role" id="btn_change_role" value="Change" onclick="change_user_role();" /><input type="reset" name="btn_cancel" id="btn_cancel" value="Cancel" /></center></td></tr>								
</table>
<?php 
}
?>
