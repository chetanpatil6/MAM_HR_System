...
function employee_filter()
	{
	//alert("Hello");
	var str1=document.getElementById('cmb_emp_name').value
	var str2=document.getElementById('cmb_month_no').value
	//alert(str1);
		...
		{
		var myTable = document.getElementById('attendancetable');
	...
	xmlhttp.open("GET","emp_attd.php?id1="+str1+"&id2="+str2,true);
	xmlhttp.send();
	}
</script>	
...
<td><label>Select Employee Name:</label></td>
										...
										<?php
										 ...
										 while($r_emp_name=mysql_fetch_assoc($sql_emp_name)){
										     echo "<option value='$r_emp_name[employee_no]'>$r_emp_name[first_name] $r_emp_name[middle_name] $r_emp_name[last_name]</option>";
											 $count++;
										 }											 								 
										?>
										</select>
										<input type="text" name="cmb_month_no" id="cmb_month_no" value="<?php echo $_POST['cmb_month_no'] ?>" style="display:none" />
										</td>
</tr>
</table>
<br /><br /><br />
...
<tr><td width="248"><b><center>Employee Name:<font color="#FF0000">*</font></center></b></td><td width="72"><b><center>Month No <font color="#FF0000">*</font></center></b></td><td width="72"><b>Working Days<font color="#FF0000">*</font></b></td><td width="72"><b>Holidays<font color="#FF0000">*</font></b></td><td width="72"><b>Paid Leaves</b></td><td width="72"><b><center>Unpaid Leaves</center></b></td><td width="72"><b>Suspension Days</b></td><td width="72"><b>No of adjustment days, from prev month</b></td><td><b>Overtime in Hours for the month</b></td><td><b>No of Days for leave Encashment</b></td><td width="76"><b><center>Income Tax</center></b></td></tr>
</thead>
