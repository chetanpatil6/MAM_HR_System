...
<tr><td><b>Grade:</b></td><td><input type="text" name="txt_grade" id="txt_grade" /></td><td><b>Compensation Code:</b></td><td><input type="text" name="txt_comp_code" id="txt_comp_code"  size="20" /></td>
</tr>
...
<tr><td colspan="5"><center><input type="button" name="btn_add_grade_wise_compensation" id="btn_add_grade_wise_compensation" value="Save" /><input type="reset" name="btn_reset" value="Cancel" /></center></td></tr>
