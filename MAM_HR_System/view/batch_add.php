...
<?php
$sq_btch = mysql_query("select * from batch_hdr");
$count_btch = mysql_num_rows($sq_btch) + 1;
?>
<tr><td><b>Batch No:</b><font color="#FF5F55">*</font></td><td colspan="3"><input type="text" name="txt_batch_no" id="txt_batch_no" style="display:none" value="<?php echo $count_btch; ?>" />
<input type="text" name="txt_batch_no_to_display" id="txt_batch_no_to_display" disabled="disabled" value="<?php echo $count_btch; ?>" />
</td>
</tr>
<tr>
...
<?php
$sql1 = mysql_query("select empl_master.employee_no, empl_master.first_name, empl_master.middle_name, empl_master.last_name from empl_master, comp_details  where comp_details.employee_no=empl_master.employee_no and comp_details.type_of_sep='' order by empl_master.last_name");
...
$sql2 = mysql_query("select * from comp_head where comp_code='F0001' OR comp_code='F0003' OR comp_code='F0004' OR comp_code='F0002'");
while($row2 = mysql_fetch_assoc($sql2))
{
  echo "<option value='$row2[comp_code]'>$row2[comp_name]</option>";
}
?>
...
?>
										...
										<center><b><div id="error7"></div></b></center>
