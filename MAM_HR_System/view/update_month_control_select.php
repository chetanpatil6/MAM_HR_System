...
function btnenable()
		    ...
		    var a= document.getElementById("cmb_month_no").value;
...
?>
		...
		<form name="frm_update_month_control" id="frm_update_month_control" action="update_month_control_details.php" method="post" onsubmit="return btnenable()">
		<center><table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Update Month Control Details</center></font></td></tr></table>

		<table width="800" border="1" class="listing" align="center">
			<tr><td width="300"><b>Select Month No: </b></td>
				<td><select name="cmb_month_no" id="cmb_month_no" style="widows:250px">
