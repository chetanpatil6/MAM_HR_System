...
<form action="#" method="post" name="frm_update_grade_details">
...
<?php
$grade = $_POST['cmb_grade'];
?>
<tr><td width="220"><b>Grade:</b><font color="#FF0000">*</font></td><td colspan="5"><input type="text" name="txt_grade" id="txt_grade" value="<?php echo $grade; ?>" disabled="disabled" /></td>
</tr>
</table>
<br />
<table width="800" border="1" id="tblgradecomp">
<?php
$sql = mysql_query("select * from grade_comp_master where grade='$grade'");
while($row = mysql_fetch_assoc($sql))
{
?>				
<tr>
<td><b>Compensation Code:</b><font color="#FF0000">*</font></td><td><input type="text" name="txt_compe_code" id="txt_compe_code"  size="20" value="<?php echo $row['comp_code'] ?>" disabled="disabled" /></td>
<td><b>Amount</b><font color="#FF0000">*</font></td><td colspan="3"><input type="text" name="txt_amounts" id="txt_amounts"  value="<?php echo $row['amount'] ?>" /></td></tr>
			 
<?php  }?>
</table>
<table width="800" border="1">
<tr><td colspan="6"><center><input type="button" name="btn_update_grade_wise_compensation" id="btn_update_grade_wise_compensation" value="Update" onclick="update_grade_wise_compensation();"  /><input type="reset" name="btn_reset" value="Cancel" /></center></td></tr>
