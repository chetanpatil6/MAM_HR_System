...
<head><script src="../calendar/src/js/jscal2.js"></script>
...
<tr><td><b>Employee Code:</b></td><td><input type="text" name="txt_emp_code" id="txt_emp_code" /></td><td><b>Compensation Code:</b></td><td><input type="text" name="txt_comp_code" id="txt_comp_code"  size="20" /></td>
</tr>
...
<tr><td colspan="5"><center><input type="button" name="btn_add_emp_compensation" id="btn_add_emp_compensation" value="Save" /><input type="reset" name="btn_reset" value="Cancel" /></center></td></tr>
