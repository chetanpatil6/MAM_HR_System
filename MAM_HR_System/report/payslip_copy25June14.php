...
$sq = mysql_query("select * from payroll_hdr, empl_master, comp_details where empl_master.employee_no=payroll_hdr.employee_no and comp_details.employee_no=payroll_hdr.employee_no and payroll_hdr.month_no='$month_no' order by comp_details.designation, empl_master.emp_code");
