 ...
 if($emp_code=='All')
		{
					...
					$sq = mysql_query("select * from payroll_hdr, empl_master where empl_master.employee_no=payroll_hdr.employee_no and payroll_hdr.month_no='$month_no' order by empl_master.emp_code");
						...
						$r2['pf_number'] = "MH-26567/".$r2['pf_number'];
						 ...
						 "Bank Account/Cheque No : ".$r2['bank_account_no']."\n"."PF Account No.                  : ".$r2['pf_number']."\n"."No. of Days in Month         : ".$no_days));
						  ...
						  //$pdf->Row(array("Bank Account/Cheque No :".$r2['bank_account_no'],"Father/Husband's Name. : ".$r3['spouse_name']));
							...
							$pdf->Row(array("Working Days: ".$r_attendance['pay_days'], "Holidays: ".$r_attendance['holidays'], "Paid Leaves: ". $r_attendance['paid_leaves'], "Unpaid Leaves: ".$r_attendance['unpaid_leaves']));
	 	...
	 	{
				//$sq = mysql_query("select * from payroll_hdr where employee_no='$emp_no' and month_no='$month_no'");
				$sq = mysql_query("select * from payroll_hdr, empl_master where empl_master.employee_no=payroll_hdr.employee_no and payroll_hdr.month_no='$month_no' and emp_code='$emp_code' order by empl_master.emp_code");
				while($r1 = mysql_fetch_assoc($sq))
				{
				$emp_no = $r1['employee_no'];
				$gross_earn = $r1['gross_earnings'];
