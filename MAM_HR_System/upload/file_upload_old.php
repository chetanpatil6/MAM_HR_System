	 ...
	 if($count != 0)
	 {
     	if($filedata[0] != 0 && $filedata[1] != 0)
		 {
				...
				if($sum_days > 31)
				{
  				...
  				mysql_query("insert into attendance values('$filedata[0]', '$filedata[1]', '$filedata[2]', '$filedata[3]', '$filedata[4]', '$filedata[5]', '$filedata[6]', '$filedata[7]', '$filedata[8]', '$filedata[9]', '', '', '', '')");
		}		
	}
	$count = 1;
 }
