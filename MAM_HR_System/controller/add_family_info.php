...
$dbconnect->add_family_info($emp_no,$spouse_Name, $spouse_contact_no, $no_of_family_member, $no_of_dependents,$name1,$relation1,$age1,$gaurdian1,$name2,$relation2,$age2,$gaurdian2);
?>