...
$dbconnect->add_recovery($emple_no,$recovery_title, $total_amount,$no_of_installments,$installment_amount_per_salary,$amount_balance_after_recovery,$compen_code,$recovery_status,$remark_any);
?>