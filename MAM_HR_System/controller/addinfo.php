...
$dbconnect->addinfo($name, $address1,  $address2,  $address3, $address4, $city, $pin_code, $state, $country, $phone_number, $landline, $email,  $alternate_email, $vat_no, $cst_no, $service_tax_no, $exicise_regn_no, $accessee_code,$certificate_no,$rate_of_duty,$income_tax_no, $pan_no,$exicise_range, $exicise_div,$commissionorate,$pla_ac_no, $sign1,$sign2,$sign3);
