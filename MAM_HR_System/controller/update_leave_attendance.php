...
$dbconnect->update_leave_attendance($emp_no,$month, $no_day_month, $week_off, $working_days, $present_days, $paid_days, $unpaid_days,$absent_days, $suspen_days,$encashment_days,$remark);
?>