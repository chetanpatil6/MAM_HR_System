...
$.post('../controller/add_company_info.php', {emp_no:emp_no,date_of_joining:date_of_joining, comp_change_eff_date:comp_change_eff_date, designation:designation,grade:grade, basic:basic, hra:hra, special:special, conveyance:conveyance,lta:lta, pf_applicable:pf_applicable, prof_tax_applicable:prof_tax_applicable, esi_applicable:esi_applicable,bank_branch_name:bank_branch_name,account_no:account_no,pf_no:pf_no,pf_date:pf_date,dearness_pay:dearness_pay,da:da,gross_salary:gross_salary,ctc:ctc,emp_type:emp_type,emp_cat:emp_cat,date_confirm:date_confirm,date_sep:date_sep,type_sep:type_sep,remark_sep:remark_sep,salary_on_joining:salary_on_joining,mode_of_payment:mode_of_payment,gratuity_applicable:gratuity_applicable,tds_applicable:tds_applicable,pension_fund_applicable:pension_fund_applicable, lic_acc_1:lic_acc_1, lic_amt_1:lic_amt_1, lic_acc_2:lic_acc_2, lic_amt_2:lic_amt_2, loan_acc_1:loan_acc_1, loan_amt_1:loan_amt_1, loan_acc_2:loan_acc_2, loan_amt_2:loan_amt_2}, function(data){
				$('#error2').text(data);
});
}
