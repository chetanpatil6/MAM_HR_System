            ...
            <div class="art-Sheet-body">
                <div class="art-Header">
					...
					<td>
						...
						<form name="frm_logout" id="frm_logout" method="post" action="../index1.php">
...
<form name="payroll_process" id="payroll_process" action="../controller/payroll_process.php" method="post">
<table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Payroll Process</center></font></td></tr></table> 

<center><table width="800" class="listing" border="1">
<tr><td><b>Select Month: </b><select name="cmb_month_no" id="cmb_month_no"><?php  
...
</td><td><input type="submit" value="Process" name="btn_process" id="btn_process" /></td></tr>			
</table>
</center>						
</form>
<br /><br /><br />		

<!-- Form to print Sample payslip -->	


			
<form name="payroll_print" id="payroll_print" action="#" method="post" target="_blank" onsubmit="return btnenable()">
<table width="900"><tr><td><font face="Courier New, Courier, monospace" size="+1" color="#FF6600"><center>Print/View Payroll Slips</center></font></td></tr></table> 

<center><table width="800" class="listing" border="1">
	
							
<tr><td><b>Select Month: </b><select name="cmb_month_no1" id="cmb_month_no1">
...
<td><center><input type="submit" value="Print Pay Slips" name="btn_print" id="btn_print" onclick="submitForm('../report/payslip.php')" /><input type="submit" value="View Pay Slips" name="btn_print" id="btn_print" onclick="submitForm('../report/payslip_new.php')" /></center></td></tr>
...
<tr><td colspan="2"><b><center>Deduction Report</center></b></td></tr>						
<tr><td><b>Select Month: </b><select name="cmb_month_no_deduction" id="cmb_month_no_deduction">
<?php  
...
?></select></td>
<td><input type="submit" name="btn_deduction_print" id="btn_deduction_print" value="Deduction Report" /></td>
</tr>
...
<center><table width="800" class="listing" border="1">
	...
	<tr><td colspan="2"><b><center>Earning Report</center></b></td></tr>							
<tr><td><b>Select Month: </b><select name="cmb_month_no_earning" id="cmb_month_no_earning">
<?php  
...
?></select></td>
<td><input type="submit" name="btn_earning_print" id="btn_earning_print" value="Earnings Report" /></td>
</tr>
